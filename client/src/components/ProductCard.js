  ...
  return (
    ...
    >
      {pathname.includes("cart") &&
        <div className="bg-red-400 absolute w-6 px-2 rounded-full top-2 right-3 text-white">
      ...
      <div className='flex gap-2 mt-5'>
        ...
        {pathname.includes("cart") &&
          <button className='bg-red-500 rounded-full py-1 px-2 flex-1 text-white text-bold' onClick={() => dispatch(removeFromCart(product))}>
            Remove From Cart
          </button>
        }
        {!pathname.includes("cart") &&
